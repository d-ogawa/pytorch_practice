...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="LSTM",
                        help="type of recurrent net (RNN_TANH, RNN_RELU, LSTM, GRU) [LSTM] .")
    parser.add_argument("--emsize", type=int, default=200,
                        help="size of word embeddings [200] .")
    parser.add_argument("--nhid", type=int, default=200,
                        help="number of hidden units per layer [200] .")
    parser.add_argument("--nlayers", type=int, default=2,
                        help="number of layers [2] .")
    parser.add_argument("--lr", type=float, default=20,
                        help="initial learning rate [20] .")
    ...
    parser.add_argument("--tied", action="store_true",
                        help="tie the word embedding and softmax weights [False] .")
    ...
    parser.add_argument("--save", type=str, default="model.pt",
                        help="path to save the finel model [model.pt] .")
